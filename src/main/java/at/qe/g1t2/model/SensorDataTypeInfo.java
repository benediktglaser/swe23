...
/**
 *  This class represent an Entity which is responsible for setting and getting the min and max limits. Its id is being
 *  autogenerated and each min max value has its own type from enum class SensorDataType.
 */
